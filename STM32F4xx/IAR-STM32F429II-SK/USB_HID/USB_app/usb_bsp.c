 ...
 *                  Device Library by ST. Adapted for IAR-STM32F429II-SK board.
 *
 *    History :
 *    1. Date        : October 2013
...
GPIO_InitTypeDef GPIO_InitStructure;
  ...
  GPIO_PinAFConfig(OTG_HS_ID_PORT,OTG_HS_ID_SOURCE,GPIO_AF_OTG2_FS);
  ...
  GPIO_Init(OTG_HS_VBUS_PORT, &GPIO_InitStructure);
