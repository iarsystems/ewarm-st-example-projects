...
{
  /* Get the Analog watchdog0 comparison result */ 
  ComparisonResult = ADC_GetAnalogWatchdogResult(ADC_AnalogWatchdog0);

  /* Show Analog watchdog0 comparison result on leds */
  GPIO_Write(GPIO1, ComparisonResult );

  /* Clear the last Analog Watchdog0 comparison result flags */
  ADC_ClearFlag(ADC_FLAG_AnalogWatchdog0_HighThreshold | ADC_FLAG_AnalogWatchdog0_LowThreshold);
