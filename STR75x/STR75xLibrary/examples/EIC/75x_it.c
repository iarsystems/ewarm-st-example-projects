...
{
  /* Toggle led connected to P1.2 pin */
  GPIO_WriteBit(GPIO1, GPIO_Pin_2, (BitAction)((1-GPIO_ReadBit(GPIO1, GPIO_Pin_2))));
...
{
  /* Toggle led connected to P1.1 pin */
  GPIO_WriteBit(GPIO1, GPIO_Pin_1, (BitAction)((1-GPIO_ReadBit(GPIO1, GPIO_Pin_1))));
...
{
  /* Toggle led connected to P1.0 pin */
  GPIO_WriteBit(GPIO1, GPIO_Pin_0, (BitAction)((1-GPIO_ReadBit(GPIO1, GPIO_Pin_0))));
  
  /* Clear the TIM0 Update pending Bit */
