...
int main()
{
  ...
  /* OPM configuration: External pulse received on TIM0_TI1 pin, OPM in PWM 
     mode is used, the delay is fixed to 2.18 ms and the pulse is fixed to 6.55 ms */
  TIM_InitStructure.TIM_Mode = TIM_Mode_OPM_PWM;           
  ...
  TIM_InitStructure.TIM_RepetitivePulse = TIM_RepetitivePulse_Enable;       
