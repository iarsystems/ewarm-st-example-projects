...
/* CK_TIM = 30 MHz, Prescaler = 0x0, 
  ...
  /* TIM0 used as Master in Enable Mode for TIM1
     TIM0 used as Master in Enable Mode for TIM2 
     TIM2 and TIM1 are used as Slaves in Gated Mode: both  the start and the stop are 
     controlled by the Master */ 
  TIM_SynchroConfig(TIM0_Master, TIM1_Slave, TIM_SynchroAction_Enable, TIM_SynchroMode_Gated);
  TIM_SynchroConfig(TIM0_Master, TIM2_Slave, TIM_SynchroAction_Enable, TIM_SynchroMode_Gated);
