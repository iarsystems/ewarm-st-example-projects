...
static volatile Boolean HID_RepotrEpDly;
static volatile Boolean RelativeData0;   // that flag is associated with relative data (X,Y)
static volatile Boolean HID_Cnfg, HID_Decnfg;
