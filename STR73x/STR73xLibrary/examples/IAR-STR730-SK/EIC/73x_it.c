...
{
   GPIO_BitWrite(GPIO0, GPIO_PIN_2,(BitAction)(~(GPIO_BitRead(GPIO0,GPIO_PIN_2))));
   TIM_FlagClear(TIM1,TIM_FLAG_TO);
}
...
{
   GPIO_BitWrite(GPIO0, GPIO_PIN_4,(BitAction)(~(GPIO_BitRead(GPIO0,GPIO_PIN_4))));
   TIM_FlagClear(TIM2,TIM_FLAG_TO);
}
...
{
   GPIO_BitWrite(GPIO0, GPIO_PIN_6,(BitAction)(~(GPIO_BitRead(GPIO0,GPIO_PIN_6))));
...
void TIM4_IRQHandler (void)
{
   ...
   GPIO_BitWrite(GPIO0, GPIO_PIN_8,(BitAction)(~(GPIO_BitRead(GPIO0,GPIO_PIN_8))));
   TIM_FlagClear(TIM4,TIM_FLAG_TO);
}
...
void TIM5_IRQHandler (void)
{
   ...
   GPIO_BitWrite(GPIO0, GPIO_PIN_10,(BitAction)(~(GPIO_BitRead(GPIO0,GPIO_PIN_10))));
   TIM_FlagClear(TIM5,TIM_FLAG_TO);
...
{
    GPIO_BitWrite(GPIO0, GPIO_PIN_12,(BitAction)(~(GPIO_BitRead(GPIO0,GPIO_PIN_12))));
    TIM_FlagClear(TIM6,TIM_FLAG_TO);
}
...
{
    GPIO_BitWrite(GPIO0, GPIO_PIN_14,(BitAction)(~(GPIO_BitRead(GPIO0,GPIO_PIN_14))));
    TIM_FlagClear(TIM7,TIM_FLAG_TO);
}
