...
/* Private macro ---------------------------------------------------------------*/
/* Private variables -----------------------------------------------------------*/
extern PRCCU_InitTypeDef    PRCCU_InitStructure;
...
{
   /* Enter in LPWFI mode */
  PRCCU_EnterLPM(PRCCU_LPM_LPWFI); /* MCLK= (CLOCK2=2MHz)/16 = 125KHz in LPWFI */
}
...
{
   /* MCLK= CLOCK2= 4MHz/2 = 2MHz */
  PRCCU_Init(&PRCCU_InitStructure);
  /* Now MCLK should be equal to 12 MHz */
}
