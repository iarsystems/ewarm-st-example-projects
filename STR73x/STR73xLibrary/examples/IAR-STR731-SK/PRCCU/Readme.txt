...
5) Start GPIO0 toggling  with a MCLK frequency = 12MHz
  - To enter in LPWFI mode press B1 button
  ...
  - To exit LPWFI mode press B2 button
  ...
  - To re-enter in LPWFI mode press B1 button (The same procedure could be done)	 

Note : This example is running on STR731 IAR  board and uses "B1" and "B2" push-buttons
       which are connected respectively to pins GPIO5.8/INT06 and GPIO5.9/INT07.
