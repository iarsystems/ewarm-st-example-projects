...
/*******************************************************************************
* Function Name  : STIM0_IRQHandler
* Description    : This function handles the STIM0 interrupt request.
* Input          : detail input parameters
* Output         : detail output parameters
* Return         : detail return value
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : STIM1_IRQHandler
* Description    : This function handles the STIM1 interrupt request.
* Input          : detail input parameters
* Output         : detail output parameters
* Return         : detail return value
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : STIM2_IRQHandler
* Description    : This function handles the STIM2 interrupt request.
* Input          : detail input parameters
* Output         : detail output parameters
* Return         : detail return value
*******************************************************************************/
