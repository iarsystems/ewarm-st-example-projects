...
- Configuration of 6 TIM (TIM0..TIM5)timers to generate an interrupt
...
- Assignment of a descendant IRQ priority for each IRQ channel :
  TIM1 has a priority of 5  and TIM5 has a priority of 1.
- In each interrupt routine, a pin of GPIO0 is chosen to toggle
