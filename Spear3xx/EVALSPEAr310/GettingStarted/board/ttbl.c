...
const TtSectionBlock_t TtSB[] =
{
  ...
  // 1864 MB section section no cached (RAS)
  L1_SECTIONS_ENTRY(1864,0x40000000,0x40000000         ,1,0,0,0),
  ...
  //  33 MB section section no cached (High Speed)
  L1_SECTIONS_ENTRY(  33,0xE0800000,0xE0000000         ,1,0,0,0),
