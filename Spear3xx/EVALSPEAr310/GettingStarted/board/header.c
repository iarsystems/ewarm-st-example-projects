 ...
 *    Description : bootloader for SPEAR310 board
 *
 *
 *    History :
 *    2. Date        : December 13, 2010
...
// note : reserved vector (0x14, SPEAR300_cstartup) hold application image size
// vector 14 will be updated /or not from flashloader too
// all othe field should in bigendian too.
