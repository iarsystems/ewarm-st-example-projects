 ...
 * to develop code for a SPEAR300 board. It shows basic use of I/O, system 
 * initialization PLL, DDR2, VIC, MMU, GPIO and timer.
 *
 *  Set the jumpers and the switches regarding the EVALSPEAR300 User's Manual
 *
 * It toggle port RS_PORT bit 0-3 (J7 pin2 - pin5) 15 times per second.
 *
 *    $Revision: 39 $
 *
 **************************************************************************/
