...
const Int32U mt47h64m16_3_333_cl5[] =
{
	 	0x02020201
	,	0x02020202
	,	0x01000000
...
__arm void low_level_init (void)
{
  ...
  MEM7_CTL = 0x01000100;
#if 0
  AMEM_CFG_CTRL_bit.amem_clk_enb = 1;

#define RAS_ENB_REG_320		0xB300000C
#define RAS_MODE_REG_320	0xB3000010
#define RAS_IPS_ENB_320		0xFFFFAC04
#define RAS_MODE_320		  0x1
  volatile unsigned int * reg;
  // Set OP mode
  reg = (volatile unsigned int *)RAS_ENB_REG_320;
  *reg = RAS_IPS_ENB_320;
  reg = (volatile unsigned int *)RAS_MODE_REG_320;
  *reg = RAS_MODE_320;
#endif
}
