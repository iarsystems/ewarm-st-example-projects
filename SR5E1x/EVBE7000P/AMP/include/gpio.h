...
typedef enum {
    ...
    GPIO_PORT_Q,  /**< GPIO Port Q */
    GPIO_PORT_R,  /**< GPIO Port R */
    GPIO_PORT_S,  /**< GPIO Port S */
    GPIO_PORT_T,  /**< GPIO Port T */
    GPIO_PORT_V,  /**< GPIO Port V */
    GPIO_PORT_W,  /**< GPIO Port W */
    GPIO_PORT_X,  /**< GPIO Port X */
    GPIO_PORT_Y   /**< GPIO Port Y */
} gpio_port_t;
 ...
 * @api
 */
__STATIC_INLINE GPIO_TypeDef *gpio_get_port_reg(gpio_port_t port) {
 ...
 * @api
 */
__STATIC_INLINE gpio_io_t gpio_iopack(gpio_port_t port, gpio_pin_t pin) {

    return ((gpio_io_t)(((port) << 4U) | (pin & 0x0FU)));
}
 ...
 * @api
 */
__STATIC_INLINE gpio_port_t gpio_iounpack_port(gpio_io_t io) {

    return ((gpio_port_t)((io) >> 4U));
}
 ...
 * @api
 */
__STATIC_INLINE gpio_pin_t gpio_iounpack_pin(gpio_io_t io) {

    return ((gpio_pin_t)((io) & 0x0FU));
}
...
__STATIC_INLINE void gpio_set_pin_moder(gpio_io_t io,
    ...
    GPIO_TypeDef *p  = gpio_get_port_reg(port);
