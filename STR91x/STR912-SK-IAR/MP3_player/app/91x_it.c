...
extern void MP3_DmaHandler(Int32U IntrType);
extern void Tim0Handler(void);
...
{
#if MP3_STREAM_MODE_ENA > 0
  if (DMA_GetITStatus(Channel6,DMA_IS))
  {
    MP3_DmaHandler(DMA_GetITStatus(Channel6,DMA_ES)?0:1);
  }
#endif // MP3_STREAM_MODE_ENA > 0

#if SPI_DMA_ENA > 0
  if(DMA_GetITStatus(Channel4,DMA_IS))
  {
    SPI0_DmaHandler();
  }
  if(DMA_GetITStatus(Channel5,DMA_IS))
  {
    SPI0_DmaHandler();
  }
#endif // SPI_DMA_ENA > 0
