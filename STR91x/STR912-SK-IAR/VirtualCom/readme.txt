...
===========
  ...
  to develop code for the IAR-STR912-SK evaluation board. It implements an USB 
  CDC (Communication Device Class) device and installs it like a Virtual COM 
...
COMPATIBILITY
=============
  The project is compatible with the IAR-STR912-SK evaluation board.
  The project is by default configured to use the J-Link JTAG interface.

  This example can work standalone on the IAR-STR912-SK board.
...
===============
  ...
  2) Run the example.
  3) Use an USB cable to connect the PC to the USB of the board
