 ...
 *
 *************************************************************************/
uint32_t WM8731_Init(I2C_HandleTypeDef * hi2c)
{
uint32_t result = WM8731_RESULT_OK;
  ...
  result |= WM8731_Reset(hi2c);

  result |= WM8731_Headphone_Volume(hi2c, WM8731_LHO_LHPVOL_Mute);

  result |= WM8731_LineIn_Mute(hi2c, TRUE);
  
  result |= WM8731_DAIF_Set(hi2c, WM8731_DAIF_FORMAT_I2SLeft1J | WM8731_DAIF_LRP_RightOnHigh);

  result |= WM8731_SC_Set(hi2c, WM8731_SC_SR_Set(0x08));

  result |= WM8731_DAPC_Set(hi2c, 0);

  result |= WM8731_AAPC_Set(hi2c, registerAAPC);

  result |= WM8731_ActivateInterface(hi2c, TRUE);
  
  result |= WM8731_PowerDownControl(hi2c, WM8731_PDC_MICPD_Disable   |
  ...
  result |= WM8731_Headphone_Volume(hi2c, (WM8731_LHO_LHPVOL_Max+WM8731_LHO_LHPVOL_Min)/2);
 ...
 *
 *************************************************************************/
uint32_t WM8731_LineIn_Mute_Left(I2C_HandleTypeDef * hi2c, Boolean Mute)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
  ...
  if (SUCCESS_RESULT != I2C_SEND_FUNC(WM8731_ADDR, &Data[0], 2)) { I2C_CLOSE_FUNC(); return WM8731_RESULT_ERROR;}
 ...
 *
 *************************************************************************/
uint32_t WM8731_LineIn_Mute_Right(I2C_HandleTypeDef * hi2c, Boolean Mute)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_LineIn_Mute(I2C_HandleTypeDef * hi2c, Boolean Mute)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
  Data[0]  = WM8731_RLIN << 1;
 ...
 *
 *************************************************************************/
uint32_t WM8731_LineIn_Volume_Left(I2C_HandleTypeDef * hi2c, uint8_t volume)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_LineIn_Volume_Right(I2C_HandleTypeDef * hi2c, uint8_t volume)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_LineIn_Volume(I2C_HandleTypeDef * hi2c, uint8_t volume)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
  if(volume > WM8731_RLIN_RINVOL_Max) volume = WM8731_RLIN_RINVOL_Max;
  Data[0]  = WM8731_RLIN << 1;
 ...
 *
 *************************************************************************/
uint32_t WM8731_PowerDownControl(I2C_HandleTypeDef * hi2c, uint8_t pdc)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
  Data[0] = WM8731_PDC << 1;
  Data[1] = pdc;
 ...
 *
 *************************************************************************/
uint32_t WM8731_Headphone_Volume_Left(I2C_HandleTypeDef * hi2c, uint8_t volume)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_Headphone_Volume_Right(I2C_HandleTypeDef * hi2c, uint8_t volume)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_Headphone_Volume(I2C_HandleTypeDef * hi2c, uint8_t volume)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
  if(volume > WM8731_RHO_RHPVOL_Max) volume = WM8731_RHO_RHPVOL_Max;
  if(volume < WM8731_RHO_RHPVOL_Min) volume = WM8731_RHO_RHPVOL_Mute;
 ...
 *
 *************************************************************************/
uint32_t WM8731_AAPC_Set(I2C_HandleTypeDef * hi2c, uint8_t aapc)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_Mic_Mute(I2C_HandleTypeDef * hi2c, Boolean Mute)
{
  if (Mute)
    return WM8731_AAPC_Set(hi2c, registerAAPC | (1<<WM8731_AAPC_MUTEMIC));
  else
    return WM8731_AAPC_Set(hi2c, registerAAPC & ~(1<<WM8731_AAPC_MUTEMIC));
}
 ...
 *
 *************************************************************************/
uint32_t WM8731_Mic_Boost(I2C_HandleTypeDef * hi2c, Boolean Boost)
{
  if (Boost)
    return WM8731_AAPC_Set(hi2c, registerAAPC | (1<<WM8731_AAPC_MICBOOST));
  else
    return WM8731_AAPC_Set(hi2c, registerAAPC & ~(1<<WM8731_AAPC_MICBOOST));
}
 ...
 *
 *************************************************************************/
uint32_t WM8731_InputSelectMic(I2C_HandleTypeDef * hi2c)
{
  return WM8731_AAPC_Set(hi2c, registerAAPC | (1<<WM8731_AAPC_INSEL));
}
 ...
 *
 *************************************************************************/
uint32_t WM8731_InputSelectLineIn(I2C_HandleTypeDef * hi2c)
{
  return WM8731_AAPC_Set(hi2c, registerAAPC & ~(1<<WM8731_AAPC_INSEL));
}
 ...
 *
 *************************************************************************/
uint32_t WM8731_SC_Set(I2C_HandleTypeDef * hi2c, uint8_t sc)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
  Data[0] = WM8731_SC << 1;
  Data[1] = sc;
 ...
 *
 *************************************************************************/
uint32_t WM8731_DAIF_Set(I2C_HandleTypeDef * hi2c, uint8_t daif)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_DAPC_Set(I2C_HandleTypeDef * hi2c, uint8_t dapc)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_Reset(I2C_HandleTypeDef * hi2c)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
 ...
 *
 *************************************************************************/
uint32_t WM8731_ActivateInterface(I2C_HandleTypeDef * hi2c, Boolean Active)
{
  if(0 == hi2c) return WM8731_RESULT_HWFAULT;
  Data[0] = WM8731_AC << 1;
  Data[1] = (Active)?1:0;
