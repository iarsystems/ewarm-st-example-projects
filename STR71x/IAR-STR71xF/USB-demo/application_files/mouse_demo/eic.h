...
* Return         : None
*******************************************************************************/
inline void EIC_IRQConfig(functionalstate NewStatus)
{
  if (NewStatus==ENABLE) EIC->ICR |= 0x0001; else EIC->ICR &= ~0x0001;
}
...
* Return         : None
*******************************************************************************/
inline void EIC_FIQConfig(functionalstate NewStatus)
{
  if (NewStatus==ENABLE) EIC->ICR |= 0x0002; else EIC->ICR &= ~0x0002;
}
...
* Return         : None
*******************************************************************************/
inline void EIC_IRQChannelConfig(IRQChannel_TypeDef IRQChannel, functionalstate NewStatus)
{
  if (NewStatus==ENABLE) EIC->IER |= 0x0001 << IRQChannel;
...
{
  if (NewStatus==ENABLE) EIC->FIR |= FIQChannel;
