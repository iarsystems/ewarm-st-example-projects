...
===================
 ...
 This example demonstrates the following features of the ADC12 :
  ...
  3) Get the conversion Data Average for 0V
    - Wait until the BUT push button is pressed
 ...
 6) Compute the ADC quatium in µV
   ...
   - Wait until BUT push button is pressed
...
This example requires at least 0V and 2.5V on the ADC analog channel 3. 
 - On the STR711/12 IAR board, the 0V can be applied by connecting AIN3 to GND.
