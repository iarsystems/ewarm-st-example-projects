...
===================
 ...
 Timer 1 is configured to measure the frequency and the duty-cycle of an
 input signal using the timer Input Capture A module.

 This example run at 32MHz with a 4 MHz external oscilator.
...
=======================
 An external square signal must be injected at P1.4 pin.
