...
===================
 ...
 monted on the STR71x IAR board)to execute the interrupt code.
 If the program work properly you will see the first led of the GPIO1 port pins
