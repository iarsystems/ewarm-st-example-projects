 ...
 *    2. Date        : June 9, 2014
 *       Author      : Stanimir Bonev
 *       Description : add new type of LCD
 *
 *    $Revision: 1513 $
 **************************************************************************/
#include "drv_glcd.h"
...
static const GLCD_CmdCtrl_t GLCD_Cmd_Iss0_type0[GLCD_CMD_NUMB] =
{
// (ISS=0)
// NOP - No Operation
  {0x00, GLCD_WRITE, 0, 0},
...
static const GLCD_CmdCtrl_t GLCD_Cmd_Iss0_type1[GLCD_CMD_NUMB] =
{
// (ISS=0)
// NOP - No Operation
  {0x00, GLCD_WRITE, 0, 0},
...
Int32U Contrast;
  ...
  case GLCD_ISS_1:
    ...
    break;
  case GLCD_ISS_0_TYPE1:
    pGLCD_CmdCtrl = (pGLCD_CmdCtrl_t)(GLCD_Cmd_Iss0_type1 + Cmd);
    break;
  default:
    pGLCD_CmdCtrl = (pGLCD_CmdCtrl_t)(GLCD_Cmd_Iss0_type0 + Cmd);
    break;
  }
  if(Write2_DRAM)
  {
	...
	else if(Glcd_Iss==GLCD_ISS_0_TYPE1)
	{
		switch(Cmd)
		{
		case PTIN:
...
pDATCTR_Data_t pDATCTR_Data;
  ...
  if(((Data        & 0xFF) == GLCD_ISS_0_TYPE1) ||
     (((Data >> 16)& 0xFF) == GLCD_MOD_ID))
  {
    Glcd_Iss = GLCD_ISS_0_TYPE1;
  }
  else if(((Data        & 0xFF) != GLCD_MANF_ID) ||
          (((Data >> 16)& 0xFF) != GLCD_MOD_ID))
  {
  ...
  {
    // Set contrast
    Data = (Glcd_Iss == GLCD_ISS_0_TYPE1)?0x3F:0x30;
