...
/* Private define ------------------------------------------------------------*/
/* LED Definitions */
#define LED_MSK         0x00000FFF  /* PB8..15*/
#define LED_On(led)     GPIOC->ODR |=  led
#define LED_Off(led)    GPIOC->ODR &= ~led
#define LED_Toggle(led) GPIOC->ODR ^=  led
#define LED_Output(led) GPIOC->ODR = (GPIOB->ODR & ~LED_MSK) | led
...
GPIO_InitTypeDef GPIO_InitStructure;
  ...
  /* Configure PC6..9 as outputs push-pull, max speed 50 MHz */
