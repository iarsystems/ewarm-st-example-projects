...
signed short mkfs_makevfat(Partition *part)
{
    ...
    *((unsigned char*)(buf+67 + 0)) = (0x13371337 >> 0) & 0xff;
    *((unsigned char*)(buf+67 + 1)) = (0x13371337 >> 8) & 0xff;
    *((unsigned char*)(buf+67 + 2)) = (0x13371337 >>16) & 0xff;
    *((unsigned char*)(buf+67 + 3)) = (0x13371337 >>24) & 0xff;
