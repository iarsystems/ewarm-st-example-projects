...
struct sMenuItem CommunicationTestMenuItems[] = {{" USB         ","USB",USB_Test, IdleFunc},
										         {" USART1         ","USART1", USART1_Test, IdleFunc},
...
struct sMenuItem PeriphTestsMenuItems[] = {{" Ext SRAM         ","Ext SRAM", Ext_SRAM_Test, IdleFunc},
                                                                                   {  " Stepper Motor  ","Stepper Motor", Stepper_Motor_Test, IdleFunc    },
                                                                                   {  " Accelerometer         ","Accelerometer", Accelerometer_Test, IdleFunc    },
										   {  " Potentiometer         ","Potentiometer", Potentiometer_Test, IdleFunc},
										   {  " SD Card         ","SD Card", SD_Card_Test, IdleFunc},
...
void IntExtOnOffConfig(FunctionalState NewState)
{
  ...
  /* Disable the EXTI line 13, 14 and 15 on falling edge */
  if(NewState == DISABLE)
  {
  ...
  /* Enable the EXTI line 13, 14 and 15 on falling edge */
  else
  {
