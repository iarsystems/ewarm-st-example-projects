...
#define _CP_MASK  GPIO_Pin_3
#define _CP_PORT  GPIOD

#define _WP_MASK  GPIO_Pin_5
#define _WP_PORT  GPIOE
...
{
  return(Bit_SET == GPIO_ReadInputDataBit(_CP_PORT,_CP_MASK));
}
...
{
  return(Bit_RESET == GPIO_ReadInputDataBit(_WP_PORT,_WP_MASK));
}
...
Int32U StatusReg;
  ...
  while(Length)
  {
    ...
    DMA_InitStructure.DMA_MemoryBaseAddr = (Int32U)pData;
