 ...
 *
 *    File name   : main.c
 *    Description : Option byte manipulation project
 *
 *    History :
 *    1. Date        : November 9, 2009
 ...
 * The low level configuration can only be controlled using low-level JTAG 
 * commands.
 * 
 ...
 * Enable/disable writes protection. This function will erase flash memory, if 
 * flash memory not read protected.
 *  0xAA - WRP3
 *  0xBB - WRP2
 *  0xCC - WRP1
 *  0xDD - WRP0
 ...
 * 
 * stm32_data(0xAABB)
 * Set user data bytes. This function will erase flash memory, if flash memory 
 * not read protected.
 *  0xAA - Data0
 *  0xBB - Data1
 *
