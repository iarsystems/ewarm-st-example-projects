/**
  ...
  * @version V4.X.0RC10
  * @date    07/06/2011
  * @brief   This file contains definitions for STM32XYNERGY's Leds, push-buttons
...
#ifndef __STM32XYNERGY_H
#define __STM32XYNERGY_H
...
/** @addtogroup STM32XYNERGY
  * @{
  */
      
/** @addtogroup STM32XYNERGY_LOW_LEVEL
  * @{
  */ 

/** @defgroup STM32XYNERGY_LOW_LEVEL_Exported_Types
  * @{
  */
/**
  * @}
...
/** @defgroup STM32XYNERGY_LOW_LEVEL_Exported_Constants
  * @{
  */ 

/** @addtogroup STM32XYNERGY_LOW_LEVEL_LED
  * @{
  */
#define LEDn                             5
...
#define OTG_SW_ON_PIN                         GPIO_Pin_2
#define OTG_SW_ON_GPIO_PORT                   GPIOB
#define OTG_SW_ON_GPIO_CLK                    RCC_AHB1Periph_GPIOB
  
#define USB_DATA_PIN                         GPIO_Pin_11
#define USB_DATA_GPIO_PORT                   GPIOA
#define USB_DATA_GPIO_CLK                    RCC_AHB1Periph_GPIOA

#define FLASH_OE_PIN                     GPIO_Pin_11
#define FLASH_OE_GPIO_PORT               GPIOF
#define FLASH_OE_GPIO_CLK                RCC_AHB1Periph_GPIOF
...
/** @addtogroup STM32XYNERGY_LOW_LEVEL_BUTTON
  * @{
  */  
#define BUTTONn                          3 

/*!< Joystick pins are connected to 
 ...
 * @brief OTG_ALARM
 */
#define OTG_ALARM_PIN                   GPIO_Pin_3
#define OTG_ALARM_GPIO_PORT             GPIOA
#define OTG_ALARM_GPIO_CLK              RCC_AHB1Periph_GPIOA
#define OTG_ALARM_EXTI_LINE             EXTI_Line3
#define OTG_ALARM_EXTI_PORT_SOURCE      EXTI_PortSourceGPIOA
#define OTG_ALARM_EXTI_PIN_SOURCE       EXTI_PinSource15
#define OTG_ALARM_EXTI_IRQn             EXTI15_10_IRQn
/**
  * @}
  */ 

/** @addtogroup STM32XYNERGY_LOW_LEVEL_COM
  * @{
  */
#define COMn                             1
...
/** @addtogroup STM32XYNERGY_LOW_LEVEL_SD_FLASH
  * @{
  */ 
/**
  * @brief  SD FLASH SDIO Interface
  */
#define SD_DETECT_PIN                    GPIO_Pin_8                 /* PI.9 */
#define SD_DETECT_GPIO_PORT              GPIOG                       /* GPIOI */
...
/** @addtogroup STM32XYNERGY_LOW_LEVEL_I2C_EE
  * @{
  */
/**
...
/** @defgroup STM32XYNERGY_LOW_LEVEL_Exported_Macros
  * @{
  */  
/**
  * @}
...
/** @defgroup STM32XYNERGY_LOW_LEVEL_Exported_Functions
  * @{
  */
