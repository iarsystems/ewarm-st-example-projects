/**
  ...
  *              serial EEPROM (sEE)
  *          available on STM32XYNERGY-EVAL evaluation board from SILICA.
  ******************************************************************************
  * @copy
  *
...
/** @defgroup STM32XYNERGY_LOW_LEVEL 
  * @brief This file provides firmware functions to manage Leds, push-buttons, 
  *        COM ports, SD card on SDIO and serial EEPROM (sEE) available on 
  *        STM3220F-EVAL evaluation board from STMicroelectronics.
  * @{
  */ 

/** @defgroup STM32XYNERGY_LOW_LEVEL_Private_TypesDefinitions
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32XYNERGY_LOW_LEVEL_Private_Defines
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32XYNERGY_LOW_LEVEL_Private_Macros
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32XYNERGY_LOW_LEVEL_Private_Variables
  * @{
  */ 
GPIO_TypeDef* GPIO_PORT[LEDn] = {LED1_GPIO_PORT, LED2_GPIO_PORT, OTG_SW_ON_GPIO_PORT,
                                 USB_DATA_GPIO_PORT, FLASH_OE_GPIO_PORT};
const uint16_t GPIO_PIN[LEDn] = {LED1_PIN, LED2_PIN, OTG_SW_ON_PIN,
                                 USB_DATA_PIN, FLASH_OE_PIN};
const uint32_t GPIO_CLK[LEDn] = {LED1_GPIO_CLK, LED2_GPIO_CLK, OTG_SW_ON_GPIO_CLK,
                                 USB_DATA_GPIO_CLK, FLASH_OE_GPIO_CLK};
...
const uint16_t BUTTON_PORT_SOURCE[BUTTONn] = {WAKEUP_BUTTON_EXTI_PORT_SOURCE,
                                              ...
                                              OTG_ALARM_EXTI_PORT_SOURCE};
								 
const uint16_t BUTTON_PIN_SOURCE[BUTTONn] = {WAKEUP_BUTTON_EXTI_PIN_SOURCE,
                                             TAMPER_BUTTON_EXTI_PIN_SOURCE, 
                                             OTG_ALARM_EXTI_PIN_SOURCE}; 
...
/** @defgroup STM32XYNERGY_LOW_LEVEL_Private_FunctionPrototypes
  * @{
  */ 
...
/** @defgroup STM32XYNERGY_LOW_LEVEL_Private_Functions
  * @{
  */ 
