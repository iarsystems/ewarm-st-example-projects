...
===========
  ...
  to develop code for the IAR-STM32F207ZG-SK board. It shows basic use of the
...
COMPATIBILITY
=============
   The temperature sensor example project is compatible with IAR-STM32F207ZG-SK
