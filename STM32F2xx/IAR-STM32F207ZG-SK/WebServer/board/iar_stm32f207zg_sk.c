 ...
 *
 *    File name   : iar_stm32f207zg_sk.c
 *    Description : IAR-STM32F207ZG-SK board support package
 *
 *    History :
 *    1. Date        : 01 July 2013
...
USART_TypeDef* COM_USART[COMn] = {COM1_BASE, COM2_BASE};
...
const uint16_t COM_RX_PIN_SOURCE[COMn] = {COM1_RX_SOURCE, COM1_RX_SOURCE};
