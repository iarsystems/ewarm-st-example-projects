...
===========
  ...
  for ARM to develop code for the IAR-STM32F207ZG-SK board. It shows basic
...
COMPATIBILITY
=============
   The accelerometer sensor example project is compatible with IAR-STM32F207ZG-SK
...
===============
  ...
  2) Select File->Open->Workspace...
     ...
     \STM32F2xx\IAR-STM32F207ZG-SK\Accelerometer\Accelerometer.eww
