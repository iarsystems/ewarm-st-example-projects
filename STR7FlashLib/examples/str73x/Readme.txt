...
* Description        : Description of the STR73x Flash Library example. 
********************************************************************************
* History:
* 10/01/2006 : V1.0
********************************************************************************
...
Example description
===================
This example demonstrates the following features of the STR73x FLASH:
- Erase a sector
- Write a word data
...
Directory contents
==================
  - 73x_type.h       : Common data types file
...
- FLASH_WriteProtectionCmd  function and all protections routines can work
  only when the STR73x is on SystemMemory boot mode, i-e while using
  the SystemMemory bootloader.
