...
* Description        : Description of the STR71x Flash Library example. 
********************************************************************************
* History:
* 10/01/2006 : V1.0
********************************************************************************
...
Example description
===================
This example demonstrates the following features of the STR71x FLASH:
- Erase a sector
- Write a word data
...
Directory contents
==================
  - 71x_type.h       : Common data types file
